...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_empty_first_name_error_message(self):
        def callback(form):
            first_name_field = self.get_by_placeholder(form, 'Ex.:Erick')
    ...
    def test_empty_last_name_error_message(self):
        def callback(form):
            last_name_field = self.get_by_placeholder(form, 'Ex.:Starck')
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(form, 'Ex.:Erick').send_keys('First Name')
        self.get_by_placeholder(form, 'Ex.:Starck').send_keys('Last Name')
